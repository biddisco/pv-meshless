...
FUNCTION(PACKAGE_ADD_LIBRARY LIBRARY_NAME)
  ...
  PARSE_ARGUMENTS(
    ...
    "TESTONLY;NO_INSTALL_LIB_OR_HEADERS;STATICLINK" #Options
  ...
  IF (PARSE_STATICLINK)
    MESSAGE("Found static keyword")
    ADD_LIBRARY(${LIBRARY_NAME} STATIC ${PARSE_HEADERS} ${PARSE_NOINSTALLHEADERS}
      ${PARSE_SOURCES})
  ELSE (PARSE_STATICLINK)
    ADD_LIBRARY(${LIBRARY_NAME} ${PARSE_HEADERS} ${PARSE_NOINSTALLHEADERS}
      ${PARSE_SOURCES})
  ENDIF (PARSE_STATICLINK)
