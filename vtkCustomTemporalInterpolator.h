/*=========================================================================
  ...
  Module:    $RCSfile: vtkCustomTemporalInterpolator.h,v $
...
=========================================================================*/
// .NAME vtkCustomTemporalInterpolator - interpolate datasets between time steps to produce a new dataset
// .SECTION Description
// vtkCustomTemporalInterpolator interpolates between two time steps to
// produce new data for an arbitrary T.
// vtkCustomTemporalInterpolator has three modes of operation. 
...
#ifndef __vtkCustomTemporalInterpolator_h
#define __vtkCustomTemporalInterpolator_h

#include "vtkDataSetAlgorithm.h"

class vtkDataSet;

class VTK_EXPORT vtkCustomTemporalInterpolator : public vtkDataSetAlgorithm
{
public:
  static vtkCustomTemporalInterpolator *New();
  vtkTypeRevisionMacro(vtkCustomTemporalInterpolator, vtkDataSetAlgorithm);
...
private:
  vtkCustomTemporalInterpolator(const vtkCustomTemporalInterpolator&);  // Not implemented.
  void operator=(const vtkCustomTemporalInterpolator&);  // Not implemented.
};
