#ifndef SPLINE5THORDER_HPP
#define SPLINE5THORDER_HPP
...
public:
     ...
     */
    KernelSpline5thOrder(int dim, double smoothingLength);
    ...
    virtual double getDilationFactor() const { return 3.0; }
...
private:
     ...
     */
    KernelSpline5thOrder& operator=(const KernelSpline5thOrder& non);
